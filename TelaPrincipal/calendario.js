document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderReminders = () => {
        ...
        if (dayReminders.length === 0) {
            reminderList.innerHTML = `<li style="justify-content: center; color: #8a8a8e;">Nenhuma tarefa para este dia.</li>`;
            return;
        }
    ...
    const renderProvas = () => {
        ...
        if (provas.length === 0) {
            provasList.innerHTML = '<li style="color: #8a8a8e;">Nenhuma prova adicionada.</li>';
            return;
        }
    ...
    editModal.addEventListener('click', (e) => {
        if (e.target.classList.contains('cancel-btn') || e.target.classList.contains('modal-overlay')) {
            closeEditModal();
        }
    });
