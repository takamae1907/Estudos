document.addEventListener('DOMContentLoaded', () => {
    ...
    const bancoDeQuestoes = {
        "direito-constitucional": {
            ...
            icon: "fa-gavel",
            questoes: [
                { enunciado: "Qual dos seguintes NÃO é um fundamento da República Federativa do Brasil, segundo a Constituição?", alternativas: ["Soberania", "Cidadania", "Pluralismo político", "Objetivos do desenvolvimento nacional"], respostaCorreta: 3 },
                { enunciado: "A quem compete privativamente legislar sobre direito civil, comercial e penal?", alternativas: ["Aos Estados", "Aos Municípios", "À União", "Ao Distrito Federal"], respostaCorreta: 2 },
                { enunciado: "O Habeas Corpus é o remédio constitucional cabível para proteger qual direito?", alternativas: ["Direito à informação", "Direito de locomoção", "Direito de petição", "Anular ato lesivo ao patrimônio público"], respostaCorreta: 1 }
            ]
        },
        "lingua-portuguesa": {
            ...
            icon: "fa-book",
            questoes: [
                { enunciado: "Na frase 'A casa, que era antiga, foi demolida', a oração destacada é:", alternativas: ["Subordinada Adjetiva Restritiva", "Subordinada Adjetiva Explicativa", "Coordenada Sindética Explicativa", "Subordinada Substantiva Apositiva"], respostaCorreta: 1 },
                { enunciado: "Qual palavra é acentuada pela mesma regra de 'história'?", alternativas: ["Saída", "Herói", "Relógio", "País"], respostaCorreta: 2 },
                { enunciado: "Assinale a alternativa em que o uso da crase está INCORRETO:", alternativas: ["Fui à Bahia no verão.", "Refiro-me àquele aluno.", "Ele escreve à lápis.", "A reunião será às três horas."], respostaCorreta: 2 }
            ]
        },
        "raciocinio-logico": {
            ...
            icon: "fa-brain",
            questoes: [
                { enunciado: "A negação da proposição 'Todo homem é mortal' é:", alternativas: ["Nenhum homem é mortal", "Todo homem é imortal", "Existe pelo menos um homem que não é mortal", "Existe pelo menos um homem que é mortal"], respostaCorreta: 2 },
                { enunciado: "Se Ana é mais alta que Bia, e Bia é mais alta que Carla, qual a relação entre Ana e Carla?", alternativas: ["Carla é mais alta que Ana", "Ana é mais baixa que Carla", "Ana tem a mesma altura que Carla", "Ana é mais alta que Carla"], respostaCorreta: 3 }
            ]
        },
        "direito-penal": {
            nome: "Direito Penal",
            ...
            questoes: [
                { enunciado: "O crime de homicídio é classificado como um crime contra:", alternativas: ["A honra", "O patrimônio", "A vida", "A administração pública"], respostaCorreta: 2 },
                { enunciado: "Agir em legítima defesa é uma causa de exclusão de:", alternativas: ["Tipicidade", "Ilicitude", "Culpabilidade", "Punibilidade"], respostaCorreta: 1 }
            ]
        }
    };
